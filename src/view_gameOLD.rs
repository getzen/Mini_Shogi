...
//     fn square_with(&self, coord: &Coord) -> &Sprite {
//         let square = self.squares.iter().find(|s| s.coord == *coord);
//         square.unwrap()
//     }
...
//         self.square_with(coord).contains_id = 
//     }
...
//         let mut new_selected_piece: Option<usize> = None;
//         for piece in &mut self.pieces {
//             let on_piece = piece.highlight_on_mouse_over();
//             //let on_piece = piece.contains(mouse_pos);
//             // if on_piece && left_button_released {
//             //     new_selected_piece = Some(piece.id);
//             // }
//         }
//         if new_selected_piece.is_some() {
//             if self.selected_piece.is_some() {
//                 let piece = self.piece_sprite_with(self.selected_piece.unwrap());
//                 piece.unwrap().highlighted = false;
//             }
//             self.selected_piece = new_selected_piece;
//             let piece = self.piece_sprite_with(self.selected_piece.unwrap());
//             piece.unwrap().highlighted = true;
//         }
//     }

//     fn square_contains_piece

//     fn piece_sprite_with(&mut self, id: usize) -> Option<&mut Sprite> {
//         for piece in &mut self.pieces {
//             if piece.id == id {
//                 return Some(piece);
//             }
